...
```c#
static const uint32     cs_maxNumCarsInUDPData = 24;
...
|Car Telemetry 2|16|Regulatory Telemetry for 2026 Season|
...
int16 m_gForceLateral; // Lateral G-Force component
int16 m_gForceLongitudinal; // Longitudinal G-Force component
int16 m_gForceVertical; // Vertical G-Force component
